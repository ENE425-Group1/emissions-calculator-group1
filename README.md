...
#### This section is for research on relevant methods for calculating emissions from transportation. Document with all the methodologies previously researced by Group 1 can be found [here](https://docs.google.com/document/d/1lYmhqOsNPrKsHHmqBDZx6apvHNXIWH4zdgCUNXkfTMw/edit?usp=sharing). The original method used for the app is based on the "UK Government greenhouse gas conversion factors". Alternatively, we are considering using the methodology used in "The Norwegian Emission Inventory" report from 2016. Both methods are described below. 
